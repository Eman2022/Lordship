...
VALUES (NULL, 'Standard Manufactured Home Lot Terms', 'LAND', 0, 45, 2, 4, 2, 0, 'FLAT',65, 'FLAT', 35),
       (NULL, 'Standard Residential Terms',           'RESIDENTIAL', 0, 45, 2, 4, 2, 45, 'FLAT', 65, 'FLAT', 35),
       (NULL, 'Standard Storage Terms',               'STORAGE', 0, 0, 0, 0,0, 0, 'NONE', 0, 'FLAT', 25);
