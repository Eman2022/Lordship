...
public record LotRow(
    ...
    public LotRow(String propertyCode, String lotNumber, String lotTypeCode,
                  String description, String notes, Integer sortOrder) {
        this(null, propertyCode, lotNumber, lotTypeCode, description, notes, sortOrder, null, null);
    }
}